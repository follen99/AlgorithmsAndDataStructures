...
var removeHeadButton;
var removeEndButton;
var addHeadButton;
var removeAtRandomButton;
var pushButton;
...
function setup() {
  ...
  removeEndButton = createButton("Remove end");
  //addHeadButton = createButton("Push at head");
  removeAtRandomButton = createButton("Remove random idex");
  pushButton = createButton("Push");

  removeHeadButton.mousePressed(removeHead);
  removeEndButton.mousePressed(removeEnd);
  //addHeadButton.mousePressed(addHead);
  removeAtRandomButton.mousePressed(removeRandom);
  pushButton.mousePressed(pushFunction);
...
function removeRandom(){
  var randomIndex = floor(random(0, list.size-1));
...
function pushFunction(){
  ...
  list.insert("new", index);
  list.get(index).x = defX;
    list.get(index).y = defY;
